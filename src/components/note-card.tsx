      ...
      <Dialog.Root>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className='fixed overflow-hidden left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[640px] w-full h-[60vh] bg-slate-700 rounded-md flex flex-col outline-none'>
            ...
            <button type='button' className='w-full bg-slate-800 py-4 text-center text-sm text-slate-300 outline-none font-medium hover:underline'><span className='text-red-400'>Deseja apagar essa nota?</span></button>
          </Dialog.Content>
        </Dialog.Portal>
      </Dialog.Root>
    )
